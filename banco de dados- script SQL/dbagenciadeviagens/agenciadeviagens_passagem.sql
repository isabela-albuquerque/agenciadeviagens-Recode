...
CREATE TABLE `passagem` (
  `id_passagem` varchar(10) NOT NULL,
  `id_viagem` varchar(10) DEFAULT NULL,
  `id_cliente` varchar(10) DEFAULT NULL,
  `classe` varchar(50) DEFAULT NULL,
  `numero_assento` int DEFAULT NULL,
  ...
  CONSTRAINT `passagem_ibfk_1` FOREIGN KEY (`id_viagem`) REFERENCES `viagem` (`id_viagem`),
  CONSTRAINT `passagem_ibfk_2` FOREIGN KEY (`id_cliente`) REFERENCES `cliente` (`id_cliente`)
...
-- Dump completed on 2025-02-09 16:29:42
